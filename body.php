  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/trendy-banner1.jpg" alt="Fashion Sale" style="width:100%;">
        <div class="carousel-caption">
          <h3 style="color: #FFD700; font-size: 32px; font-weight: bold;">Summer Sale 2024</h3>
          <p style="color: white; font-size: 18px;">Up to 50% off on trendy fashion</p>
        </div>
      </div>

      <div class="item">
        <img src="img/trendy-banner2.jpg" style="width:100%;">
        <div class="carousel-caption">
          <h3 style="color: #FFD700; font-size: 32px; font-weight: bold;">Electronics Mega Deals</h3>
          <p style="color: white; font-size: 18px;">Latest gadgets at best prices</p>
        </div>
      </div>
    
      <div class="item">
        <img src="img/trendy-banner3.jpg" alt="Accessories" style="width:100%;">
        <div class="carousel-caption">
          <h3 style="color: #FFD700; font-size: 32px; font-weight: bold;">Accessory Specials</h3>
          <p style="color: white; font-size: 18px;">Complete your look with our accessories</p>
        </div>
      </div>
